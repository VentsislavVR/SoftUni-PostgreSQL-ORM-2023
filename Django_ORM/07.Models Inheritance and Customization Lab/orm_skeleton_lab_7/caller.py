...
#
# lion = Mammal.objects.create(name="Simba",
#                              species="Lion",
...
#
# snake = Reptile.objects.create(name="Kaa",
#                                species="Python",
...
# v1 = Veterinarian.objects.create(first_name="John",
#                                  last_name="Doe",
...
#
# v2 = Veterinarian.objects.create(first_name="Alice",
#                                  last_name="Johnson",
