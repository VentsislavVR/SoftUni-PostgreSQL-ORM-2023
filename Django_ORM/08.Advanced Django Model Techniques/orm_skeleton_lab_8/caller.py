...
from main_app.models import Restaurant, Menu, RestaurantReview, FoodCriticRestaurantReview, RegularRestaurantReview, \
    MenuReview
...
#     rating=4.88)
#
# restaurant2 = Restaurant.objects.create(name="Restaurant B", location="456 ElmSt.",
#                                         description="Charming restaurant", rating=3.59)
#
...
#
# duplicate_review = RestaurantReview(reviewer_name="Aleks",
#                                     restaurant=restaurant1, review_content="Another great meal!", rating=5)
#
# try:
#
...
#                                         rating=4.88)
#
# RegularRestaurantReview.objects.create(reviewer_name="Bob",
#                                        restaurant=restaurant1,
#                                        review_content="Good experience overall.",
#                                        rating=4)
#
# RegularRestaurantReview.objects.create(reviewer_name="Aleks",
#                                        restaurant=restaurant1,
#                                        review_content="Great food and service!",
#                                        rating=5)
# duplicate_review = RegularRestaurantReview(reviewer_name="Aleks",
#                                            restaurant=restaurant1,
...
#     rating=4.2,)
#
# restaurant_from_db = Restaurant.objects.get(
#     name="Savory Delight")
#
# RegularRestaurantReview.objects.create(reviewer_name="Alice",
#                                        restaurant=restaurant_from_db,
#                                        rating=4,
#                                        review_content="Good experience"
#                                                       "overall.")
#
# review_from_db = RegularRestaurantReview.objects.get(reviewer_name="Alice",
#                                                      restaurant=restaurant_from_db)
#
...
#
# MenuReview.objects.create(reviewer_name="Lilly", menu=menu_from_db, rating=5,
#                           review_content="Delicious food")
#
# menu_review_from_db = MenuReview.objects.get(reviewer_name="Lilly",
#                                              menu=menu_from_db)
#
