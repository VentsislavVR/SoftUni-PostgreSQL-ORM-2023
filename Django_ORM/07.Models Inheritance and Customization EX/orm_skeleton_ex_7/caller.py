...
# print(
#     f"Forwarded message from {forwarded_message.sender.username} to"
#     f"{forwarded_message.receiver.username}")
...
# credit_card1 = CreditCard.objects.create(
#     card_owner="Krasimir",
...
#
# credit_card3 = CreditCard.objects.create(
#     card_owner="Vankata",
