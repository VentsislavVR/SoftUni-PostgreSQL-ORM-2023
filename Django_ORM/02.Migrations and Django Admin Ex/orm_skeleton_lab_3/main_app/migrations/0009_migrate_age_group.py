# Generated by Django 4.2.4 on 2023-10-23 17:25
...
def reverse_func(apps, schema_editor):
    ...
    for person in person_model.objects.all():
        person.age_group = age_group_default # no age group
    person_model.objects.bulk_update(person_model, ['age_group'])
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_age_group, reverse_func),
    ]
