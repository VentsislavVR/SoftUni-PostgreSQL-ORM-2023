# Generated by Django 4.2.4 on 2023-11-19 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, default=0, max_digits=3, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(10)])),
                ('is_classic', models.BooleanField(default=False)),
                ('actors', models.ManyToManyField(to='main_app.actor')),
                ('direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movies', to='main_app.director')),
